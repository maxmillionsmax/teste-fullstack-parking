...
insert into "public"."cliente"(id, nome, telefone, endereco, mensalista, valor_mensalidade,data_inclusao) values
  ('11111111-1111-1111-1111-111111111111','João Souza','31999990001','Rua A, 123',true,189.90,'2025-08-18'),
  ('22222222-2222-2222-2222-222222222222','Maria Lima','31988880002','Av. B, 456',false,null,now()),
  ('33333333-3333-3333-3333-333333333333','Carlos Silva','31977770003','Rua C, 789',true,159.90,now()),
  ('44444444-4444-4444-4444-444444444444','Ana Paula','31966660004','Av. D, 101',false,null,now()),
  ('55555555-5555-5555-5555-555555555555','Beatriz Melo','31955550005','Rua E, 202',true,209.90,now());
